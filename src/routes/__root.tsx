...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bhanu Rawal — Executive Leader, Enterprise Transformer & AI Innovator" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Bhanu Rawal — Executive Leader & AI Innovator" },
      {
        ...
        content:
          "Enterprise transformation leader driving AI adoption and measurable business value across global organizations.",
      },
